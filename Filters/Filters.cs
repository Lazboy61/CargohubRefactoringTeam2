...
//       var helloOptions = context.RequestServices.GetService<IOptions<HelloOptions>>();
//       /*
...
//         return;
//       }
//       if (context.Request.Headers["HelloApiToken"] != helloOptions.Value.ApiToken)
//       {
//         Console.WriteLine($"{context.Request.Path} was requested but the HelloApiToken is {context.Request.Headers["HelloApiToken"]} instead of {helloOptions.Value.ApiToken}");
//         context.Response.StatusCode = 401;
//         return;
//       }
//       await next();
